...
def train_args():
    ...
    parser.add_argument('--learn_rate', default=8e-5, type=float,
    ...
    parser.add_argument('--num_timecells', default=1, type=int,
                        help='Control matrix time resolution in ms.')
    ...
    # Model properties.
    parser.add_argument('--samples_per_frame', default=60, type=int,
