...
class SynthNormalized:
    ...
    def get_prepared_values(self,carrier_weight, mod_weight,carrier_env_slope, carrier_env_offset,mod_env_slope,mod_env_offset,phase_offset,test):
    ...
    def make_output(self, net,variables,sr, carrier_stereo_detune, mod_stereo_detune):
        ...
        (dur,carrier_weight, mod_weight,carrier_env_slope, carrier_env_offset,mod_env_slope,mod_env_offset,phase_offset,test) = variables
        t2 = torch.linspace(0, dur, int(dur * sr)).to(self.device)
        carrier_weight, mod_weight,carrier_env_slope, carrier_env_offset,mod_env_slope,mod_env_offset,phase_offset = self.get_prepared_values(carrier_weight, mod_weight,carrier_env_slope, carrier_env_offset,mod_env_slope,mod_env_offset,phase_offset,test)
